...
fn test_simple_parsing() {
    let input_args: Vec<String> = svec(&[
        "target/debug/move_except",
        "-c",
        "-v",
        "this_path",
        "that_path",
    ...
    let resultant = CLIArgs {
        ...
        destination: String::from("that_path"),
        files_to_move: vec![String::from("this_path")],
...
fn test_help_with_others() {
    ...
    let input_args3: Vec<String> =
        svec(&["target/debug/move_except", "--help", "--copy", "--verbose"]);
...
fn test_full_length_options() {
    ...
    let input_args2: Vec<String> = svec(&[
        "target/debug/move_except",
        "--copy",
        "this_path",
        "that_path",
    ...
    let input_args3: Vec<String> = svec(&[
        "target/debug/move_except",
        "--verbose",
        "this_path",
        "that_path",
